			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Add Shipping Method</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header">
					<div class="row">
						<div class="col-6">
							<h3 class="card-title">Add Shipping Method Form</h3>
						</div>
				...
				<!-- form start -->
				<form role="form" action="<?php echo base_url()?>insert-shipping-cost" method="POST">
					<div class="card-body">
