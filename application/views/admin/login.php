	...
	<div class="login-box">
		...
		<div class="card">
			<div class="card-body login-card-body">
				...
				<?php
				$message = $this->session->userdata('password_error_message');
				if ($message) {
					?>
					<div class="alert alert-danger" role="alert">
						...
						<?php
						echo $message;
						$this->session->unset_userdata('password_error_message');
						?>
					</div>
					<?php 
				}
				...
				<form action="<?php echo base_url();?>admin-login-check" method="post">
					<div class="input-group mb-3">
						<input type="email" class="form-control" name="admin_email" placeholder="Email Address" value="<?php echo set_value('admin_email'); ?>">
				...
				<p class="mb-1">
					<a href="<?php echo base_url()?>admin-forgot-password">I forgot my password</a>
				</p>
			</div>
			<!-- /.login-card-body -->
		</div>
